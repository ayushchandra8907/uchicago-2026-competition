...
class AConfig:
    ...
    pre_news_pullback_ms: int = 6_000
    ...
    earnings_unwind_quote_size: int = 24
    earnings_unwind_aggressive_quote_size: int = 36
    earnings_unwind_rapid_entry: int = 64
    earnings_unwind_rapid_exit: int = 24
    earnings_unwind_rapid_take_edge: int = 1
    earnings_unwind_aggressive_entry: int = 32
    earnings_unwind_aggressive_exit: int = 12
    earnings_unwind_passive_exit: int = 4
    earnings_unwind_passive_take_edge: int = 4
    shock_quote_size: int = 18
    shock_entry_window_ms: int = 1_500
    shock_entry_quote_size: int = 36
    shock_entry_min_edge: int = 1
    shock_entry_threshold_scale: float = 0.25
    shock_accumulate_target_position: int = 199
    shock_accumulate_min_quote_size: int = 39
    shock_accumulate_max_quote_size: int = 39
    shock_accumulate_min_edge: int = 0
    shock_accumulate_threshold_scale: float = 0.0
    shock_accumulate_window_ms: int = 2_000
    ...
    shock_unwind_quote_size: int = 24
    shock_unwind_aggressive_quote_size: int = 39
    shock_unwind_take_edge: int = 1
    shock_unwind_exit_position: int = 4
    prejump_enabled: bool = True
    prejump_window_ms: int = 6_000
    prejump_low_threshold: float = 0.85
    prejump_high_threshold: float = 1.35
    prejump_max_position: int = 120
    prejump_quote_size: int = 24
    prejump_aggressive_edge: int = 1


@dataclass(frozen=True)
class RiskConfig:
    reprice_cooldown_ms: int = 250
    passive_min_rest_ms: int = 500
    passive_reprice_threshold_ticks: int = 3
    ...
    *,
    ...
    return BotConfig(
        ...
        market_a=AConfig(
            ...
            pre_news_pullback_ms=_optional_int("A_PRE_NEWS_PULLBACK_MS", 6_000) or 6_000,
            ...
            earnings_unwind_quote_size=_optional_int("A_EARNINGS_UNWIND_QUOTE_SIZE", 24) or 24,
            earnings_unwind_aggressive_quote_size=_optional_int("A_EARNINGS_UNWIND_AGGRESSIVE_QUOTE_SIZE", 36) or 36,
            earnings_unwind_rapid_entry=_optional_int("A_EARNINGS_UNWIND_RAPID_ENTRY", 64) or 64,
            earnings_unwind_rapid_exit=_optional_int("A_EARNINGS_UNWIND_RAPID_EXIT", 24) or 24,
            earnings_unwind_rapid_take_edge=_optional_int("A_EARNINGS_UNWIND_RAPID_TAKE_EDGE", 1) or 1,
            earnings_unwind_aggressive_entry=_optional_int("A_EARNINGS_UNWIND_AGGRESSIVE_ENTRY", 32) or 32,
            earnings_unwind_aggressive_exit=_optional_int("A_EARNINGS_UNWIND_AGGRESSIVE_EXIT", 12) or 12,
            earnings_unwind_passive_exit=_optional_int("A_EARNINGS_UNWIND_PASSIVE_EXIT", 4) or 4,
            earnings_unwind_passive_take_edge=_optional_int("A_EARNINGS_UNWIND_PASSIVE_TAKE_EDGE", 4) or 4,
            shock_quote_size=_optional_int("A_SHOCK_QUOTE_SIZE", 18) or 18,
            shock_entry_window_ms=_optional_int("A_SHOCK_ENTRY_WINDOW_MS", 1_500) or 1_500,
            shock_entry_quote_size=_optional_int("A_SHOCK_ENTRY_QUOTE_SIZE", 36) or 36,
            shock_entry_min_edge=_optional_int("A_SHOCK_ENTRY_MIN_EDGE", 1) or 1,
            shock_entry_threshold_scale=_optional_float("A_SHOCK_ENTRY_THRESHOLD_SCALE", 0.25) or 0.25,
            shock_accumulate_target_position=_optional_int("A_SHOCK_ACCUMULATE_TARGET_POSITION", 199) or 199,
            shock_accumulate_min_quote_size=_optional_int("A_SHOCK_ACCUMULATE_MIN_QUOTE_SIZE", 39) or 39,
            shock_accumulate_max_quote_size=_optional_int("A_SHOCK_ACCUMULATE_MAX_QUOTE_SIZE", 39) or 39,
            shock_accumulate_min_edge=_optional_int("A_SHOCK_ACCUMULATE_MIN_EDGE", 0) or 0,
            shock_accumulate_threshold_scale=_optional_float("A_SHOCK_ACCUMULATE_THRESHOLD_SCALE", 0.0) or 0.0,
            shock_accumulate_window_ms=_optional_int("A_SHOCK_ACCUMULATE_WINDOW_MS", 2_000) or 2_000,
            ...
            shock_unwind_quote_size=_optional_int("A_SHOCK_UNWIND_QUOTE_SIZE", 24) or 24,
            shock_unwind_aggressive_quote_size=_optional_int("A_SHOCK_UNWIND_AGGRESSIVE_QUOTE_SIZE", 39) or 39,
            shock_unwind_take_edge=_optional_int("A_SHOCK_UNWIND_TAKE_EDGE", 1) or 1,
            shock_unwind_exit_position=_optional_int("A_SHOCK_UNWIND_EXIT_POSITION", 4) or 4,
            prejump_enabled=_optional_bool("A_PREJUMP_ENABLED", True),
            prejump_window_ms=_optional_int("A_PREJUMP_WINDOW_MS", 6_000) or 6_000,
            ...
            prejump_max_position=_optional_int("A_PREJUMP_MAX_POSITION", 120) or 120,
            prejump_quote_size=_optional_int("A_PREJUMP_QUOTE_SIZE", 24) or 24,
            prejump_aggressive_edge=_optional_int("A_PREJUMP_AGGRESSIVE_EDGE", 1) or 1,
        ),
        risk=RiskConfig(
            reprice_cooldown_ms=_optional_int("A_REPRICE_COOLDOWN_MS", 250) or 250,
            passive_min_rest_ms=_optional_int("A_PASSIVE_MIN_REST_MS", 500) or 500,
            passive_reprice_threshold_ticks=_optional_int("A_PASSIVE_REPRICE_THRESHOLD_TICKS", 3) or 3,
