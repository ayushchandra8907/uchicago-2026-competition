...
class AConfig:
    ...
    earnings_trap_enabled: bool = False
    earnings_trap_min_fair_shift_ticks: int = 60
    earnings_trap_min_aligned_inventory: int = 40
    earnings_trap_max_qty: int = 20
    earnings_trap_inventory_reserve: int = 20
    earnings_trap_offset_fraction: float = 0.10
    earnings_trap_offset_min_ticks: int = 60
    earnings_trap_offset_max_ticks: int = 120
    earnings_trap_max_lifetime_ms: int = 1_500
    ...
    *,
    ...
    return BotConfig(
        ...
        market_a=AConfig(
            ...
            earnings_trap_enabled=_optional_bool("A_EARNINGS_TRAP_ENABLED", False),
            earnings_trap_min_fair_shift_ticks=_optional_int("A_EARNINGS_TRAP_MIN_FAIR_SHIFT_TICKS", 60) or 60,
            earnings_trap_min_aligned_inventory=_optional_int("A_EARNINGS_TRAP_MIN_ALIGNED_INVENTORY", 40) or 40,
            earnings_trap_max_qty=_optional_int("A_EARNINGS_TRAP_MAX_QTY", 20) or 20,
            earnings_trap_inventory_reserve=_optional_int("A_EARNINGS_TRAP_INVENTORY_RESERVE", 20) or 20,
            earnings_trap_offset_fraction=_optional_float("A_EARNINGS_TRAP_OFFSET_FRACTION", 0.10) or 0.10,
            earnings_trap_offset_min_ticks=_optional_int("A_EARNINGS_TRAP_OFFSET_MIN_TICKS", 60) or 60,
            earnings_trap_offset_max_ticks=_optional_int("A_EARNINGS_TRAP_OFFSET_MAX_TICKS", 120) or 120,
            earnings_trap_max_lifetime_ms=_optional_int("A_EARNINGS_TRAP_MAX_LIFETIME_MS", 1_500) or 1_500,
